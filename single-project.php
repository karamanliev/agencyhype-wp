...
<div class="block subnav">
	<div class="et_pb_row">
		<ul class="sub-navbar navbar-left">
			<li><?php previous_post_link( '%link', '<img src="//develop.karamanliev.com/agencyhype/img/icons/menu-arrow-left.png">' ); ?></li>
			<li><?php next_post_link( '%link', '<img src="//develop.karamanliev.com/agencyhype/img/icons/menu-arrow-right.png">' ); ?></li>
			<li><span><?php echo get_the_title(); ?></span></li>
		</ul>
		<ul class="sub-navbar navbar-right"></ul>
	</div>
</div>
