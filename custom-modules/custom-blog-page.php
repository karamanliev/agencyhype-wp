...
class Custom_ET_Builder_Module_Blog_Page extends ET_Builder_Module_Type_PostBased {
	function init() {
		$this->name       = esc_html__( 'Custom HYPE Blog', 'et_builder' );
		$this->slug       = 'et_pb_blog_page';
		$this->vb_support = 'on';
...
new Custom_ET_Builder_Module_Blog_Page;