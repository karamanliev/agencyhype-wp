...
class Custom_ET_Builder_Module_Portfolio_BIG extends ET_Builder_Module_Type_PostBased {
	function init() {
		$this->name       = esc_html__( 'Custom HYPE Case Study BIG', 'et_builder' );
		$this->slug       = 'et_pb_portfolio_2_big';
		$this->vb_support = 'on';
		...
		if ( $portfolio->have_posts() ) {
			while( $portfolio->have_posts() ) {
				...
				<div id="post-<?php echo esc_attr( $post->ID ); ?>" class="<?php echo esc_attr( join( $post->post_class_name, ' ' ) ); ?>">
					...
					<!-- CUSTOM PROJECT  -->
					<a class="work-item big" href="<?php echo esc_url( $post->post_permalink ); ?>" title="<?php echo esc_attr( get_the_title() ); ?>">
						<?php if ( 'on' === $fullwidth ) { ?>
							<div class="col-lg-8 col-sm-7 col-xs-12 work-img-holder">
						...
						<?php } ?>
						<div class="col-lg-4 col-sm-5 col-xs-12 work-item-content">
...
new Custom_ET_Builder_Module_Portfolio_BIG;